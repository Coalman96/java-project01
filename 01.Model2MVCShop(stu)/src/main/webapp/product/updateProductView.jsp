		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="105"><input type="text" name="prodName"
								value="<%=vo.getProdName()%>" class="ct_input_g"
			...
			<tr>
				...
				<td class="ct_write01"><input type="text" name="prodDetail"
					value="<%=vo.getProdDetail()%>" class="ct_input_g"
			...
			<tr>
				...
				<td class="ct_write01"><input type="text" name="manuDate"
					readonly="readonly" value="<%=vo.getManuDate()%>"
			...
			<tr>
				...
				<td class="ct_write01"><input type="text" name="price"
					value="<%=vo.getPrice()%>" class="ct_input_g"
			...
			<tr>
				...
				<td class="ct_write01"><input type="text" name="fileName"
					value="<%=vo.getFileName()%>" class="ct_input_g"
					style="width: 200px; height: 19px" maxLength="13" /></td>
			</tr>
			<tr>
				<td height="1" colspan="3" bgcolor="D6D6D6"></td>
			</tr>
					...
					<table border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td background="/images/ct_btnbg02.gif" class="ct_btn01"
								...
								href="javascript:fncUpdateAction();">수정</a></td>
