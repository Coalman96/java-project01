	...
	<div style="width: 98%; margin-left: 10px;">
		...
		<form name="detailForm" action="/listProduct.do" method="post">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
					<td class="ct_list_b" width="100">PNo</td>
		...
		//<td></td>-->
					...
					<td align="center">
						...
						if ("manage".equals(request.getParameter("menu"))) {
						%> <a
						href="/updateProductView.do?prodNo=<%=vo.getProdNo()%>&menu=manage" menu="manage"><%=vo.getProdName()%></a>
						<%
						} else {
					...
					<td></td>
					<td align="center"><%=vo.getRegDate()%>
					<td></td>
					<td align="left"><%=vo.getProdDetail()%>
				</tr>
				<tr>
